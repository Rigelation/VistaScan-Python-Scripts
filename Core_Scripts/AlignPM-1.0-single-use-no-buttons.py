...
UserResolution = VistaScan.GetScanParameter_Resolution() #Get current res to restore later
...
VistaScan.SetSaveDirectoryAndFilename(NewDir, NewFileName)
    #Set resolution
VistaScan.SetScanParameter_Resolution(Resolution)
...
#Check scan angle, assuming it is either 0 or 270 based on our two wiring schemes
ScanAngle = VistaScan.GetScanParameter_Angle()
#if ScanAngle == 0:
